...
- `data_rna_seq_mrna.txt` – Generic assay file from LENS
    - Generated by: `lens_files.main()`

- `data_gene_signatures.txt` – Gene expression file from LENS
    - Generated by: `lens_files.main()`

- `meta_rna_seq_mrna.txt` – Metadata file for generic assay file
    - Generated by: `lens_files.main()`

- `meta_gene_signatures.txt` – Metadata file for gene expression file
    - Generated by: `lens_files.main()`
...
Download the gene expression and generic assay files from Synapse
```
